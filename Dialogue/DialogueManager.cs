...
public class DialogueManager : MonoBehaviour
{
    ...
    {
        Debug.LogWarning("VITO Quest State changed in dialogue manager for:"+ quest.info.id + "  " + quest.state.ToString());
        Debug.LogWarning("VITO Quest State changed in dialogue manager " + quest.info.id + "State  " + quest.state.ToString());
    ...
    {
        Debug.LogWarning("VITO in UpdateInkDialogueVariable for:" + name + "  " + value.ToString());
    ...
    {
        if (!dialoguePlaying|| !inputEventContext.Equals(InputEventContext.DIALOGUE)) return;
        ContinueOrExitStory();
    }
    private void EnterDialogue(string knotName)
    {
        ...
        Debug.Log("Enter dialogue for " + knotName);
        if (!knotName.Equals(""))
        {
    ...
    private void ContinueOrExitStory()
    {
        ...
        if (story.canContinue)
        {
            ...
            Debug.Log("NextLine:" + dialogueLine);
        }
